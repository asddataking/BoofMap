...
export function AdminBrandPanel() {
  const applications = useQuery(api.profiles.listPendingBrandApplications);
  const review = useMutation(api.profiles.reviewBrandApplication);

  return (
    <section>
      <AdminPageHeader
        title="Brand applications"
        description="Review brand partnership requests"
      />
            ...
            >
              ...
              <div className="flex shrink-0 gap-2">
                <button
                  ...
                  onClick={() =>
                    review({
                      applicationId: app.id as Id<"brandApplications">,
                      action: "approve",
                    })
                  }
